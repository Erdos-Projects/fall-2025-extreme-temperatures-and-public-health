We decided to start by gathering the weather data for the largest city in each region.

We need weather data from the start of 1981 to the end of 2019.

The largest city in each region is:
...
The data are from www.visualcrossing.com